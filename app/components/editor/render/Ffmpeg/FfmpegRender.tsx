...
export default function FfmpegRender({ loadFunction, loadFfmpeg, ffmpeg, logMessages }: FileUploaderProps) {
    ...
    const render = async () => {
        ...
        const renderFunction = async () => {
            ...
            // Convert FileData (Uint8Array) to regular ArrayBuffer-backed Uint8Array for Blob
            const uint8Array = outputData instanceof Uint8Array
                ? new Uint8Array(outputData.buffer.slice(0))
                : outputData as any;
